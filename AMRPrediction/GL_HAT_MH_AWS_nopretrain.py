...
from Model_MH_AWS_nopretrain import HATConfig, HATForMaskedLM, AMRPredictor
...
for r in [1e-5]:
    for w in [0.1]:
        ...
        training_args = TrainingArguments(
            output_dir=f"./results_nd2_ep235_gf_noamr_ga{g}_it{t}_lr{r}_wd{w}_gene_lnmhattli_temp05_nopt",
            save_steps=4590,
            save_strategy='steps',
